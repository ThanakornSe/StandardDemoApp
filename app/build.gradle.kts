...
android {
    namespace = "com.smartliving.standarddemoapp"
    compileSdk = 33

    defaultConfig {
        applicationId = "com.smartliving.standarddemoapp"
        minSdk = 29
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation(project(":smart-living"))
    ...
    //implementation("com.scgwedo.smartliving:scgwedotest.sdk:0.0.11")
